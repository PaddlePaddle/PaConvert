...
missing_matchers_whitelist = {
    ...
    "torch.nn.modules.module.register_module_forward_hook": "Paddle don't support global register",
    "torch.nn.modules.module.register_module_forward_pre_hook": "Paddle don't support global register",
}
