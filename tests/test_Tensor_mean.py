...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        input = torch.tensor([[1.4907, 1.0593, 1.5696], [1.4907, 1.0593, 1.5696]])
        result = input.mean(1, True, dtype=torch.float64)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        input = torch.tensor([[1.4907, 1.0593, 1.5696], [1.4907, 1.0593, 1.5696]])
        result = input.mean(dim=1, keepdim=True, dtype=torch.float64)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        input = torch.tensor([[1.4907, 1.0593, 1.5696], [1.4907, 1.0593, 1.5696]])
        result = input.mean(dtype=torch.float64, dim=1, keepdim=True)
        """
    )
    obj.run(pytorch_code, ["result"])
