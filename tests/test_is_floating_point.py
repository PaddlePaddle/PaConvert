...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        a = torch.tensor([[4, 9], [23, 2]], dtype=torch.int64)
        result = torch.is_floating_point(input=a)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.is_floating_point(input=torch.tensor([[4, 9], [23, 2]], dtype=torch.float32))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.is_floating_point(input=torch.tensor([[4, 9], [23, 2]], dtype=torch.float16))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.is_floating_point(input=torch.tensor([[4, 9], [23, 2]], dtype=torch.bfloat16))
        """
    )
    obj.run(pytorch_code, ["result"])
