...
obj = APIBase("torch.nn.functional.lp_pool1d")
...
def test_case_3():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[[-0.5743, 0.4889, -0.0878, 0.4210, -0.0844],
                                ...
                                [0.3789, -0.0560, -0.4090, -0.1070, -1.0139],
                                [0.9204, 1.0817, -2.6126, 0.4244, 0.3272]]])
        result = torch.nn.functional.lp_pool1d(input, -float('inf'), 3)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[[-0.5743, 0.4889, -0.0878, 0.4210, -0.0844],
                                ...
                                [0.3789, -0.0560, -0.4090, -0.1070, -1.0139],
                                [0.9204, 1.0817, -2.6126, 0.4244, 0.3272]]])
        result = torch.nn.functional.lp_pool1d(input=input, norm_type=4, kernel_size=3, stride=2, ceil_mode=True)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[[-0.5743, 0.4889, -0.0878, 0.4210, -0.0844],
                                ...
                                [0.3789, -0.0560, -0.4090, -0.1070, -1.0139],
                                [0.9204, 1.0817, -2.6126, 0.4244, 0.3272]]])
        result = torch.nn.functional.lp_pool1d(input, float('inf'), 2)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[[-0.5743, 0.4889, -0.0878, 0.4210, -0.0844],
                                ...
                                [0.3789, -0.0560, -0.4090, -0.1070, -1.0139],
                                [0.9204, 1.0817, -2.6126, 0.4244, 0.3272]]])
        result = torch.nn.functional.lp_pool1d(input=input, kernel_size=3, stride=2, ceil_mode=True, norm_type=4)
        """
    )
    obj.run(pytorch_code, ["result"])
