...
def _test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 2])
        result = torch.nn.functional.cross_entropy(input, target, weight=None, reduce=True, size_average=None, ignore_index=-100, reduction='mean', label_smoothing=0.0)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 2])
        result = torch.nn.functional.cross_entropy(input, target, weight=None, reduce=True, size_average=None, ignore_index=-100, reduction='mean', label_smoothing=False)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 2])
        result = torch.nn.functional.cross_entropy(input, target, None, None, -100, True, 'mean', False)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_11():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 2])
        result = torch.nn.functional.cross_entropy(input=input, target=target, weight=None, size_average=None, ignore_index=-100, reduce=True, reduction='mean', label_smoothing=False)
        """
    )
    obj.run(pytorch_code, ["result"])
