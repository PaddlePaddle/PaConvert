...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        result = torch.nn.functional.unfold(input, (2, 3), (1,1), (2,2), (2,2))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        result = torch.nn.functional.unfold(input=input, kernel_size=(2, 3), dilation=(1,1), padding=(2,2), stride=(2,2))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_11():
    pytorch_code = textwrap.dedent(
        ...
        result = torch.nn.functional.unfold(input, (2, 3))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_12():
    pytorch_code = textwrap.dedent(
        ...
        result = torch.nn.functional.unfold(input, [2,2], [1,1], [1,1], [2,2])
...
def test_case_13():
    pytorch_code = textwrap.dedent(
        ...
        result = torch.nn.functional.unfold(input=input, kernel_size=[2,2], dilation=[1,1], padding=[1,1], stride=[2,2])
...
def test_case_14():
    pytorch_code = textwrap.dedent(
        ...
        result = torch.nn.functional.unfold(input, [2,2])
