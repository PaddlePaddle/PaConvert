...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[[[[0.9064, 1.9579], [1.6145, 1.0924]], [[1.1187, 1.9942], [1.1927, 0.8372]]]]])
        indices = torch.tensor([[[[[ 5,  2], [ 8, 30]], [[37, 54], [61, 46]]]]])
        result = F.max_unpool3d(x, indices, kernel_size=2, padding=0, stride=None, output_size=None)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[[[[0.9064, 1.9579], [1.6145, 1.0924]], [[1.1187, 1.9942], [1.1927, 0.8372]]]]])
        indices = torch.tensor([[[[[ 5,  2], [ 8, 30]], [[37, 54], [61, 46]]]]])
        result = F.max_unpool3d(x, indices, 2, None, 0, None)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[[[[0.9064, 1.9579], [1.6145, 1.0924]], [[1.1187, 1.9942], [1.1927, 0.8372]]]]])
        indices = torch.tensor([[[[[ 5,  2], [ 8, 30]], [[37, 54], [61, 46]]]]])
        result = F.max_unpool3d(input=x, indices=indices, kernel_size=2, stride=None, padding=0, output_size=None)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[[[[0.9064, 1.9579], [1.6145, 1.0924]], [[1.1187, 1.9942], [1.1927, 0.8372]]]]])
        indices = torch.tensor([[[[[ 5,  2], [ 8, 30]], [[37, 54], [61, 46]]]]])
        result = F.max_unpool3d(x, indices, 2)
        """
    )
    obj.run(pytorch_code, ["result"])
