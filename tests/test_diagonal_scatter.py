...
def test_case_3():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.arange(6.0).reshape((2, 3))
        src = torch.ones((2,))
        result = torch.diagonal_scatter(input=input, offset=0, src=src, dim1=-2)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.arange(6.0).reshape((2, 3))
        src = torch.ones((2,))
        result = torch.diagonal_scatter(input=input, src=src, offset=0, dim1=-2, dim2=1)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.arange(6.0).reshape((2, 3))
        src = torch.ones((2,))
        result = torch.diagonal_scatter(input, src, 0, -2, 1)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_6():
    ...
    pytorch_code = textwrap.dedent(
        ...
        src = torch.ones((3, 2))
        result = torch.diagonal_scatter(input, src, dim1=0, dim2=2)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_7():
    ...
    pytorch_code = textwrap.dedent(
        ...
        src = torch.ones((3,))
        result = torch.diagonal_scatter(input, src, offset=1)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_10():
    ...
    pytorch_code = textwrap.dedent(
        ...
        result = torch.diagonal_scatter(input, src, offset=0, dim1=0, dim2=1)
        """
    )
    obj.run(pytorch_code, ["result"])
