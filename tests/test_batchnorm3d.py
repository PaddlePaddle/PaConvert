...
def test_case_1():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        m = torch.nn.BatchNorm3d(5, affine=False)
        input = torch.zeros(2, 5, 6, 4, 4)
        result = m(input)
        """
    )
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        a = True
        m = torch.nn.BatchNorm3d(5, 1e-5, 0.2, affine=a, track_running_stats=True, dtype=torch.float32)
        input = torch.zeros(2, 5, 6, 4, 4)
        result = m(input)
        """
    )
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        a = False
        m = torch.nn.BatchNorm3d(5, affine=a, dtype=torch.float32)
        input = torch.zeros(2, 5, 6, 4, 4)
        result = m(input)
        """
    )
