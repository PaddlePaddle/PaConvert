...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([[1., 0., 1.],[0., 1., 1.]])
        result = torch.nn.functional.soft_margin_loss(input, target, size_average=False, reduce=True, reduction='mean')
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([[1., 0., 1.],[0., 1., 1.]])
        result = torch.nn.functional.soft_margin_loss(input, target, False, True, 'mean')
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([[1., 0., 1.],[0., 1., 1.]])
        result = torch.nn.functional.soft_margin_loss(input=input, target=target, size_average=False, reduce=True, reduction='mean')
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([[1., 0., 1.],[0., 1., 1.]])
        result = torch.nn.functional.soft_margin_loss(reduction='mean', reduce=True, size_average=False, target=target, input=input)
        """
    )
    obj.run(pytorch_code, ["result"])
