...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[1., 2., 3.],[1., 2., 3.]])
        label = torch.tensor([[1., 2., 1.],[1., 2., 3.]])
        result = torch.nn.functional.smooth_l1_loss(input, label, beta=0.2, reduce=None, reduction='mean', size_average=True)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[1., 2., 3.],[1., 2., 3.]])
        label = torch.tensor([[1., 2., 1.],[1., 2., 3.]])
        result = torch.nn.functional.smooth_l1_loss(input, label, True, None, 'mean', 0.2)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[1., 2., 3.],[1., 2., 3.]])
        label = torch.tensor([[1., 2., 1.],[1., 2., 3.]])
        result = torch.nn.functional.smooth_l1_loss(input=input, target=label, size_average=True, reduce=None, reduction='mean', beta=0.2)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_11():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[1., 2., 3.],[1., 2., 3.]])
        label = torch.tensor([[1., 2., 1.],[1., 2., 3.]])
        result = torch.nn.functional.smooth_l1_loss(input, label)
        """
    )
    obj.run(pytorch_code, ["result"])
