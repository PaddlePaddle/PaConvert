...
def test_case_3():
    ...
    expect_paddle_code = textwrap.dedent(
        ...
        target[1] = 1.0
        result = paddle.nn.functional.binary_cross_entropy_with_logits(a, target, reduce=True)
        """
    )
...
def test_case_4():
    ...
    expect_paddle_code = textwrap.dedent(
        ...
        target = paddle.zeros(3)
        target[1] = 1.0
        result = paddle.nn.functional.binary_cross_entropy_with_logits(a, target, reduce=False)
        """
    )
    obj.run(pytorch_code, expect_paddle_code=expect_paddle_code)
...
def test_case_9():
    ...
    expect_paddle_code = textwrap.dedent(
        ...
        target[1] = 1.0
        result = paddle.nn.functional.binary_cross_entropy_with_logits(
            a, target, None, None, True, "sum", None
        )
        """
    )
    obj.run(pytorch_code, expect_paddle_code=expect_paddle_code)
