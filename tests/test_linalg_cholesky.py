...
def test_case_1():
    ...
    obj.run(pytorch_code, ["result"], atol=1e-6)
...
def test_case_3():
    ...
    obj.run(pytorch_code, ["result", "out"], atol=1e-6)
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        ...
        a = torch.tensor([[1.1481, 0.9974, 0.9413],
                ...
                [0.9413, 0.6773, 1.1315]])
        out = torch.randn(3, 3)
        result = torch.linalg.cholesky(input=a, upper=True, out=out)
        """
    )
    obj.run(pytorch_code, ["result", "out"], atol=1e-6)
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        a = torch.tensor([[1.1481, 0.9974, 0.9413],
                ...
                [0.9413, 0.6773, 1.1315]])
        out = torch.randn(3, 3)
        result = torch.linalg.cholesky(out=out, upper=True, input=a)
        """
    )
    obj.run(pytorch_code, ["result", "out"], atol=1e-6)
