...
obj = APIBase("torchvision.ops.ps_roi_pool", is_aux_api=True)
...
def test_case_1():
    pytorch_code = textwrap.dedent(
        ...
        result = ps_roi_pool(input=input, boxes=boxes, output_size=7, spatial_scale=1.0)
        """
    )
...
def test_case_2():
    pytorch_code = textwrap.dedent(
        ...
        result = ps_roi_pool(input, boxes, (7, 7), 1.0)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_3():
    pytorch_code = textwrap.dedent(
        ...
        result = ps_roi_pool(spatial_scale=1.0, boxes=boxes, input=input, output_size=(7, 7))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        ...
        result = ps_roi_pool(input, boxes, output_size=(7, 7))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        result = ps_roi_pool(input, boxes=boxes, output_size=(7, 7))
        """
    )
    obj.run(pytorch_code, ["result"])
