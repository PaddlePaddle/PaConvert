...
obj = ModelAPIBase("torchvision.models.densenet201")
...
def test_case_1():
    ...
    obj.run(pytorch_code, ["densenet201"])
...
def test_case_3():
    pytorch_code = textwrap.dedent(
        """
        import torchvision
        densenet201 = torchvision.models.densenet201(progress=True, weights=None)
        """
    )
    obj.run(pytorch_code, ["densenet201"])
...
def test_case_6():
    pytorch_code = textwrap.dedent(
        """
        import torchvision
        densenet201 = torchvision.models.densenet201(pretrained=False)
        """
    )
    obj.run(pytorch_code, ["densenet201"])
