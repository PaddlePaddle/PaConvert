...
obj = ModelAPIBase("torchvision.models.resnext50_32x4d")
...
def test_case_3():
    pytorch_code = textwrap.dedent(
        """
        import torchvision
        resnext50_32x4d = torchvision.models.resnext50_32x4d(progress=True, weights=None)
        """
    )
    obj.run(pytorch_code, ["resnext50_32x4d"])
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        """
        import torchvision
        resnext50_32x4d = torchvision.models.resnext50_32x4d(weights=None)
        """
    )
    obj.run(pytorch_code, ["resnext50_32x4d"])
