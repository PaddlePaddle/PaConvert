...
obj = ModelAPIBase("torchvision.models.mobilenet_v3_large")
...
def test_case_1():
    ...
    obj.run(pytorch_code, ["mobilenet_v3_large"])
...
def test_case_3():
    pytorch_code = textwrap.dedent(
        """
        import torchvision
        mobilenet_v3_large = torchvision.models.mobilenet_v3_large(progress=True, weights=None)
        """
    )
    obj.run(pytorch_code, ["mobilenet_v3_large"])
