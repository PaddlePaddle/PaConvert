...
def test_all_type_to_cdouble():
    ...
    # for uint8 --> cdouble, since torch.Tensor does not support converting negative
...
def test_complex64_to_cdouble():
    # for complex --> cdouble, we used the new test data
    pytorch_code = textwrap.dedent(
        """
        import torch
...
def test_complex128_to_cdouble():
    # for complex --> cdouble, we used the new test data
    pytorch_code = textwrap.dedent(
        """
        import torch
