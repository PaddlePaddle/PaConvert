...
#            [ 0.9112, -1.7526, -0.4061]])
#        target = torch.tensor([[1., 2., 1.],[1., 2., 3.]])
#        loss = torch.nn.MSELoss(size_average=True, reduce=None, reduction='mean')
#        result = loss(input, target)
#        """
#    )
#    obj.run(pytorch_code, ["result"])
...
#            [ 0.9112, -1.7526, -0.4061]])
#        target = torch.tensor([[1., 2., 1.],[1., 2., 3.]])
#        loss = torch.nn.MSELoss(True, None, 'mean')
#        result = loss(input, target)
#        """
#    )
#    obj.run(pytorch_code, ["result"])
...
#            [ 0.9112, -1.7526, -0.4061]])
#        target = torch.tensor([[1., 2., 1.],[1., 2., 3.]])
#        loss = torch.nn.MSELoss(reduction='mean', reduce=None, size_average=True)
#        result = loss(input, target)
#        """
#    )
#    obj.run(pytorch_code, ["result"])
