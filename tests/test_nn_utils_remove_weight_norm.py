...
def test_case_3():
    pytorch_code = textwrap.dedent(
        ...
        import torch.nn as nn
        m = torch.nn.utils.weight_norm(nn.Linear(20, 40), name='weight', dim=0)
        m = torch.nn.utils.remove_weight_norm(m, "weight")
        a = torch.ones(20)
        result = m(a)
        """
    )
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        ...
        import torch.nn as nn
        m = torch.nn.utils.weight_norm(nn.Linear(20, 40), name='weight', dim=0)
        m = torch.nn.utils.remove_weight_norm(module=m, name="weight")
        a = torch.ones(20)
        result = m(a)
        """
    )
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        import torch.nn as nn
        m = torch.nn.utils.weight_norm(nn.Linear(20, 40), name='weight', dim=0)
        m = torch.nn.utils.remove_weight_norm(name="weight", module=m)
        a = torch.ones(20)
        result = m(a)
        """
    )
