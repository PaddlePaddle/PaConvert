...
def test_all_type_to_float():
    ...
    # for uint8 --> float, since torch.Tensor does not support converting negative
...
def test_complex64_to_float():
    # for complex --> float, we used the new test data
    pytorch_code = textwrap.dedent(
        """
        import torch
