    ...
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[[[ 1.1524,  0.4714,  0.2857],
                               ...
                               [[ 0.1024, -0.4482,  0.4137],
                                [ 0.9385,  0.4565,  0.7702],
                                [ 0.4135, -0.2587,  0.0482]]]])
        result = F.upsample_bilinear(input=input, size=None, scale_factor=2)
        """
    )
    obj.run(pytorch_code, ["result"])
    ...
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[[[ 1.1524,  0.4714,  0.2857],
                               ...
                               [[ 0.1024, -0.4482,  0.4137],
                                [ 0.9385,  0.4565,  0.7702],
                                [ 0.4135, -0.2587,  0.0482]]]])
        result = F.upsample_bilinear(input, None, 2)
        """
    )
    obj.run(pytorch_code, ["result"])
    ...
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[[[ 1.1524,  0.4714,  0.2857],
                               ...
                               [[ 0.1024, -0.4482,  0.4137],
                                [ 0.9385,  0.4565,  0.7702],
                                [ 0.4135, -0.2587,  0.0482]]]])
        result = F.upsample_bilinear(size=None, input=input, scale_factor=2)
        """
    )
    obj.run(pytorch_code, ["result"])
