...
obj = APIBase("torch.functional.stft")
    ...
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[5.975718021392822,
                          ...
                          [-0.4979677200317383,
                           ...
                           -0.19927024841308594,
                           0.19927024841308594]])
        result = torch.functional.stft(x, n_fft=4, return_complex=True)
        """
    )
    ...
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[5.975718021392822,
                          ...
                          [-0.4979677200317383,
                           ...
                           -0.19927024841308594,
                           0.19927024841308594]])
        result = torch.functional.stft(x, n_fft=4, return_complex=False)
        """
    )
    obj.run(pytorch_code, ["result"])
        ...
        x = torch.tensor([[ (5.975718021392822+0j) ,
         ...
         [(-0.4979677200317383+0j)                 ,
          ...
          (-0.19927024841308594+0j)                ,
           (0.19927024841308594+0j)                ]])
        result = torch.functional.stft(x, n_fft=4)
        """
    )
    obj.run(pytorch_code, ["result"])
    ...
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[ (5.975718021392822+0j) ,
         ...
         [(-0.4979677200317383+0j)                 ,
          ...
          (-0.19927024841308594+0j)                ,
           (0.19927024841308594+0j)                ]])
        result = torch.functional.stft(x, 4, onesided=False)
        """
    )
    obj.run(pytorch_code, ["result"])
    ...
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[5.975718021392822,
                          ...
                          [-0.4979677200317383,
                           ...
                           -0.19927024841308594,
                           0.19927024841308594]])
        result = torch.functional.stft(x, n_fft=4, center=False, return_complex=True)
        """
    )
    obj.run(pytorch_code, ["result"])
    ...
    pytorch_code = textwrap.dedent(
        ...
        x = torch.tensor([[ (5.975718021392822+0j) ,
         ...
         [(-0.4979677200317383+0j)                 ,
          ...
          (-0.19927024841308594+0j)                ,
           (0.19927024841308594+0j)                ]])
        result = torch.functional.stft(x, n_fft=4, center=False, onesided=False, return_complex=True)
        """
    )
    obj.run(pytorch_code, ["result"])
