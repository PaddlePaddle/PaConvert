...
def test_case_4():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.acos_(torch.tensor([-0.6, 0.0, 0.6], dtype=torch.float64))
        """
    )
