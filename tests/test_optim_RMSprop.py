...
def test_case_1():
    pytorch_code = textwrap.dedent(
        ...
        rmsprop = torch.optim.RMSprop(conv.parameters())
        loss.backward()
        rmsprop.step()
...
def test_case_2():
    pytorch_code = textwrap.dedent(
        ...
        rmsprop = torch.optim.RMSprop(conv.parameters(),weight_decay=0.01)
        loss.backward()
        rmsprop.step()
        result = conv.weight.mean()
        """
...
def test_case_3():
    pytorch_code = textwrap.dedent(
        ...
        rmsprop = torch.optim.RMSprop(conv.parameters(),weight_decay=0.01,lr=0.1)
        loss.backward()
        rmsprop.step()
        result = conv.weight.mean()
        """
