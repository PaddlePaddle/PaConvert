...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 0])
        result = torch.nn.functional.multi_margin_loss(input, target, p=2, margin=1, weight=None, size_average=None, reduce=None, reduction='mean')
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 0])
        result = torch.nn.functional.multi_margin_loss(input, target, 2, 1, None, None, None, 'mean')
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_11():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 0])
        result = torch.nn.functional.multi_margin_loss(input=input, target=target, p=2, margin=1, weight=None, size_average=None, reduce=None, reduction='mean')
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_12():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([1, 0])
        result = torch.nn.functional.multi_margin_loss(reduction='mean', reduce=None, size_average=None, weight=None, margin=1, p=2, target=target, input=input)
        """
    )
    obj.run(pytorch_code, ["result"])
