...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        weight = torch.tensor([[[-0.26903051, -1.42116427, -0.67254508,  1.11618853],
                                ...
                                [ 0.65067267,  0.28164786, -1.04381704,  2.01811719]]])
        bias = torch.tensor([-0.33773780,  1.08489835])
        result = F.bilinear(bias=bias, weight=weight, input2=input2, input1=input1)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        result = F.bilinear(bias=torch.tensor([-0.33773780,  1.08489835]), weight=weight, input2=input2, input1=input1)
        """
    )
    obj.run(pytorch_code, ["result"])
