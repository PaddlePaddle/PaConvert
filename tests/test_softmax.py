...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        out = torch.randn(2, 3)
        result = torch.softmax(input, dim=1, dtype=torch.float32, out=out)
        """
    )
...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        out = torch.randn(2, 3)
        result = torch.softmax(input=input, dim=1, dtype=torch.float32, out=out)
        """
    )
    obj.run(pytorch_code, ["result", "out"])
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        out = torch.randn(2, 3)
        result = torch.softmax(out=out, dtype=torch.float32, dim=1, input=input)
        """
    )
    obj.run(pytorch_code, ["result", "out"])
