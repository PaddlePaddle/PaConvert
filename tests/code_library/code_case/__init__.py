...
add_to_dict("api_torch_random_manual_seed.py", "api_paddle_random_manual_seed.py")
...
add_to_dict("api_torch_Tensor_new_tensor.py", "api_paddle_Tensor_new_tensor.py")
...
add_to_dict("api_torch_jit_script.py", "api_remove_decorator.py")
add_to_dict("non_torch_class.py", "non_paddle_class.py")
