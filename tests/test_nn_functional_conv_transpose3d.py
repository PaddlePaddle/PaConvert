...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.randn(20, 16, 10, 10, 10)
        weight = torch.randn(16, 8, 2, 2, 2)
        result = F.conv_transpose3d(x, weight, bias=None, stride=2, padding=2, output_padding=1, dilation=1, groups=2)
        """
    )
    obj.run(pytorch_code, ["result"], check_value=False)
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.randn(20, 16, 10, 10, 10)
        weight = torch.randn(16, 8, 2, 2, 2)
        result = F.conv_transpose3d(x, weight, None, 2, 2, 1, 2, 1)
        """
    )
    obj.run(pytorch_code, ["result"], check_value=False)
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.randn(20, 16, 10, 10, 10)
        weight = torch.randn(16, 8, 2, 2, 2)
        result = F.conv_transpose3d(input=x, weight=weight, bias=None, stride=2, padding=2, output_padding=1, groups=2, dilation=1)
        """
    )
    obj.run(pytorch_code, ["result"], check_value=False)
