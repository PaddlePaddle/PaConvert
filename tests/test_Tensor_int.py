...
def test_all_type_to_int():
    ...
    # for uint8 --> int, since torch.Tensor does not support converting negative
...
def test_complex64_to_int():
    # for complex --> int, we used the new test data
    pytorch_code = textwrap.dedent(
        """
        import torch
