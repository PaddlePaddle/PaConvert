...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.randn(33, 16, 30)
        weight = torch.randn(20, 8, 5)
        result = F.conv1d(x, weight, bias=None, stride=2, padding=2, dilation=1, groups=2)
        """
    )
    obj.run(pytorch_code, ["result"], check_value=False)
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.randn(33, 16, 30)
        weight = torch.randn(20, 8, 5)
        result = F.conv1d(x, weight, None, 2, 2, 1, 2)
        """
    )
    obj.run(pytorch_code, ["result"], check_value=False)
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.randn(33, 16, 30)
        weight = torch.randn(20, 8, 5)
        result = F.conv1d(input=x, weight=weight, bias=None, stride=2, padding=2, dilation=1, groups=2)
        """
    )
    obj.run(pytorch_code, ["result"], check_value=False)
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        x = torch.randn(33, 16, 30)
        weight = torch.randn(20, 8, 5)
        result = F.conv1d(groups=2, dilation=1, padding=2, stride=2, bias=None, weight=weight, input=x)
        """
    )
    obj.run(pytorch_code, ["result"], check_value=False)
