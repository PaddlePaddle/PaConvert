...
def test_case_4():
    run_torch_case(
        obj,
        """
        result = torch.floor_(torch.tensor([-2.2, 0.0, 3.3], dtype=torch.float64))
        """,
        ["result"],
    )
