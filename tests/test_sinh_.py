...
def test_case_4():
    run_torch_case(
        obj,
        """
        result = torch.sinh_(torch.tensor([-0.75, 0.0, 0.75], dtype=torch.float64))
        """,
        ["result"],
    )
