...
def test_case_1():
    ...
    obj.run(pytorch_code, ["result"], rtol=1.0e-3, atol=1.0e-4)
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        ...
        [[ 0.1024, -0.4482,  0.4137],
         ...
         [ 0.4135, -0.2587,  0.0482]]])
        data = torch.tensor([1., 1., 1.])
        result = torch.layer_norm(input, [3], data, data, 1e-4)
        """
    )
    obj.run(pytorch_code, ["result"], rtol=1.0e-3, atol=1.0e-4)
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        [[ 0.1024, -0.4482,  0.4137],
         ...
         [ 0.4135, -0.2587,  0.0482]]])
        data = torch.tensor([1., 1., 1.])
        result = torch.layer_norm(eps=1e-4, bias=data, weight=data, normalized_shape=[3], input=input)
        """
    )
    obj.run(pytorch_code, ["result"], rtol=1.0e-3, atol=1.0e-4)
...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        [[ 0.1024, -0.4482,  0.4137],
         ...
         [ 0.4135, -0.2587,  0.0482]]])
        data = torch.tensor([1., 1., 1.])
        result = torch.layer_norm(input, [3])
        """
    )
    obj.run(pytorch_code, ["result"], rtol=1.0e-3, atol=1.0e-4)
