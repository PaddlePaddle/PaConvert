...
def test_case_6():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([4.7767, 4.3234, 1.2156, 0.2411, 4.5739])
        out = torch.tensor([4.7767, 4.3234, 1.2156, 0.2411, 4.5739])
        result = torch.log1p(input=input, out=out)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([4.7767, 4.3234, 1.2156, 0.2411, 4.5739])
        out = torch.tensor([4.7767, 4.3234, 1.2156, 0.2411, 4.5739])
        result = torch.log1p(out=out, input=input)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        out =  torch.rand([4])
        result = torch.log1p(input=torch.tensor([4, 10, 7, 9]), out=out)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        out =  torch.rand([4])
        result = torch.log1p(out=out, input=torch.tensor([4, 10, 7, 9]))
        """
    )
    obj.run(pytorch_code, ["result"])
