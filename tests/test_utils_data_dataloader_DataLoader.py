...
obj = DataLoaderAPIBase("torch.utils.data.dataloader.DataLoader")
...
def test_case_1():
    pytorch_code = textwrap.dedent(
        ...
        data = Data()
        result = torch.utils.data.dataloader.DataLoader(data)
        """
    )
...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        data = Data()
        result = torch.utils.data.dataloader.DataLoader(data, batch_size=2, shuffle=True, drop_last=True)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        data = Data()
        result = torch.utils.data.dataloader.DataLoader(dataset=data, batch_size=2, num_workers=0, collate_fn=None)
        """
    )
    obj.run(pytorch_code, ["result"])
