...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        t = torch.tensor([[3.+3.j, 2.+2.j, 3.+3.j], [2.+2.j, 2.+2.j, 3.+3.j]])
        out = torch.randn(2, 3)
        result = torch.fft.irfft2(t, s=(2, 3), dim=(0, 1), norm='forward', out=out)
        """
    )
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        import torch
        t = torch.tensor([[3.+3.j, 2.+2.j, 3.+3.j], [2.+2.j, 2.+2.j, 3.+3.j]])
        result = torch.fft.irfft2(t, (2, 3), (0, 1), 'forward')
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        t = torch.tensor([[3.+3.j, 2.+2.j, 3.+3.j], [2.+2.j, 2.+2.j, 3.+3.j]])
        out = torch.randn(2, 3)
        result = torch.fft.irfft2(input=t, s=(2, 3), dim=(0, 1), norm='forward', out=out)
        """
    )
    obj.run(pytorch_code, ["result", "out"])
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        t = torch.tensor([[3.+3.j, 2.+2.j, 3.+3.j], [2.+2.j, 2.+2.j, 3.+3.j]])
        out = torch.randn(2, 3)
        result = torch.fft.irfft2(out=out, norm='forward', dim=(0, 1), s=(2, 3), input=t)
        """
    )
    obj.run(pytorch_code, ["result", "out"])
