...
obj = APIBase("torchvision.transforms.RandomHorizontalFlip")
img_obj = ImageAPIBase("torchvision.transforms.RandomHorizontalFlip")
...
def test_case_2():
    pytorch_code = textwrap.dedent(
        ...
        prob = 0.0
        flip = RandomHorizontalFlip(p=prob)
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        ...
        flip = RandomHorizontalFlip(p=0.9)
