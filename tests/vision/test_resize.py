...
def test_case_1():
    pytorch_code = textwrap.dedent(
        ...
        result = resize(img, size=size, interpolation=InterpolationMode.BILINEAR)
        """
    )
...
def test_case_2():
    pytorch_code = textwrap.dedent(
        ...
        result = resize(img, size=size, interpolation=InterpolationMode.BICUBIC)
        """
    )
    img_obj.run(pytorch_code, ["result"])
...
def test_case_3():
    pytorch_code = textwrap.dedent(
        ...
        img = img[0]
        result = resize(img, size=size, interpolation=InterpolationMode.NEAREST)
        """
    )
