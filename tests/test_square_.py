...
def test_case_4():
    run_torch_case(
        obj,
        """
        result = torch.square_(torch.tensor([-1.5, 0.0, 1.5], dtype=torch.float64))
        """,
        ["result"],
    )
