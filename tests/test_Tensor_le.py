...
def test_case_5():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.tensor([[1, 2], [3, 4]]).le(other=torch.tensor(2))
        """
    )
    obj.run(pytorch_code, ["result"])
...
def _test_case_6():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.tensor([[1, 2], [3, 4]]).le(2)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_7():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.tensor([[1, 2], [3, 4]]).le(other=torch.tensor([[1, 1], [4, 4]]))
        """
    )
    obj.run(pytorch_code, ["result"])
