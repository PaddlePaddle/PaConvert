...
def test_case_7():
    pytorch_code = textwrap.dedent(
        ...
        nn.utils.clip_grad_value_(linear.parameters(), clip_value=0.8, foreach=None)
        result=list(linear.parameters())[1].grad
        """
    )
    obj.run(pytorch_code, ["result"], check_stop_gradient=False)
...
def test_case_8():
    pytorch_code = textwrap.dedent(
        ...
        nn.utils.clip_grad_value_(linear.parameters(), 0.8, None)
        result=list(linear.parameters())[1].grad
        """
    )
    obj.run(pytorch_code, ["result"], check_stop_gradient=False)
...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        nn.utils.clip_grad_value_(parameters=linear.parameters(), clip_value=0.8, foreach=None)
        result=list(linear.parameters())[1].grad
        """
    )
    obj.run(pytorch_code, ["result"], check_stop_gradient=False)
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        nn.utils.clip_grad_value_(foreach=None, clip_value=0.8, parameters=linear.parameters())
        result=list(linear.parameters())[1].grad
        """
    )
    obj.run(pytorch_code, ["result"], check_stop_gradient=False)
...
def test_case_11():
    pytorch_code = textwrap.dedent(
        ...
        nn.utils.clip_grad_value_(linear.parameters(), 0.8)
        result=list(linear.parameters())[1].grad
        """
    )
    obj.run(pytorch_code, ["result"], check_stop_gradient=False)
