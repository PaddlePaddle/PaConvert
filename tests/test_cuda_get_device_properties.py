...
def test_case_3():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.cuda.get_device_properties(device = 0)
        """
    )
    obj.run(
        pytorch_code,
...
def test_case_4():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.cuda.get_device_properties(device = torch.device('cuda'))
        """
    )
    obj.run(
        pytorch_code,
...
def test_case_5():
    pytorch_code = textwrap.dedent(
        """
        import torch
        result = torch.cuda.get_device_properties(torch.device('cuda'))
        """
    )
    obj.run(
        pytorch_code,
