    ...
    pytorch_code = textwrap.dedent(
        ...
        [[[-2.1256,  0.9310,  1.0743],
         ...
         [[-0.5989, -0.4732,  1.3252],
          [-0.7614,  1.0493,  0.8488],
          [-0.1300,  0.1287,  0.6234]]]])
        result = torch.linalg.matrix_rank(A, atol=torch.tensor(1.0), rtol=torch.tensor(0.5),  hermitian=True)
        """
    )
    obj.run(pytorch_code, ["result"], check_dtype=False)
    ...
    pytorch_code = textwrap.dedent(
        ...
        [[[-2.1256,  0.9310,  1.0743],
         ...
         [[-0.5989, -0.4732,  1.3252],
          [-0.7614,  1.0493,  0.8488],
          [-0.1300,  0.1287,  0.6234]]]])
        result = torch.linalg.matrix_rank(input=A, atol=0.2, rtol=1.0,  hermitian=True)
        """
    )
    obj.run(pytorch_code, ["result"], check_dtype=False)
    ...
    pytorch_code = textwrap.dedent(
        ...
        [[[-2.1256,  0.9310,  1.0743],
         ...
         [[-0.5989, -0.4732,  1.3252],
          ...
          [-0.1300,  0.1287,  0.6234]]]])
        out = torch.empty((2, 4), dtype=torch.int64)
        result = torch.linalg.matrix_rank(hermitian=True, out=out, input=A, rtol=0.5)
        """
    )
    obj.run(pytorch_code, ["result"], check_dtype=False)
    ...
    pytorch_code = textwrap.dedent(
        ...
        [[[-2.1256,  0.9310,  1.0743],
         ...
         [[-0.5989, -0.4732,  1.3252],
          ...
          [-0.1300,  0.1287,  0.6234]]]])
        out = torch.empty((2, 4), dtype=torch.int64)
        result = torch.linalg.matrix_rank(hermitian=True, out=out, input=A, atol=0.5)
        """
    )
    obj.run(pytorch_code, ["result"], check_dtype=False)
    ...
    pytorch_code = textwrap.dedent(
        ...
        [[[-2.1256,  0.9310,  1.0743],
         ...
         [[-0.5989, -0.4732,  1.3252],
          [-0.7614,  1.0493,  0.8488],
          [-0.1300,  0.1287,  0.6234]]]])
        result = torch.linalg.matrix_rank(A, atol=torch.tensor(1.0),  hermitian=True)
        """
    )
    obj.run(pytorch_code, ["result"], check_dtype=False)
    ...
    pytorch_code = textwrap.dedent(
        ...
        [[[-2.1256,  0.9310,  1.0743],
         ...
         [[-0.5989, -0.4732,  1.3252],
          [-0.7614,  1.0493,  0.8488],
          [-0.1300,  0.1287,  0.6234]]]])
        result = torch.linalg.matrix_rank(A, rtol=torch.tensor(1.0),  hermitian=True)
        """
    )
    obj.run(pytorch_code, ["result"], check_dtype=False)
