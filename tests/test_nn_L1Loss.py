...
def test_case_9():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([[1.,2.,3.],[4.,5.,6.]])
        loss = torch.nn.L1Loss(size_average=None, reduce=False, reduction='mean')
        result = loss(input,target)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_10():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([[1.,2.,3.],[4.,5.,6.]])
        loss = torch.nn.L1Loss(None, False, 'mean')
        result = loss(input,target)
        """
    )
    obj.run(pytorch_code, ["result"])
...
def test_case_11():
    pytorch_code = textwrap.dedent(
        ...
        input = torch.tensor([[-1.2837, -0.0297,  0.0355],
            [ 0.9112, -1.7526, -0.4061]])
        target = torch.tensor([[1.,2.,3.],[4.,5.,6.]])
        loss = torch.nn.L1Loss(reduction='mean', reduce=False, size_average=None)
        result = loss(input,target)
        """
    )
    obj.run(pytorch_code, ["result"])
