...
def generate_optimizer_test_code(optimizer_init, step_with_closure=False):
    optimizer_segment = f"optimizer = {optimizer_init}"

    closure_step_segment = """
    ...
    code_template = f"""
        ...
        input_ = torch.tensor([[[
            [0.65819663, -1.44500113, 0.03488150, -0.11252647, 0.64591473,
        ...
        {closure_step_segment if step_with_closure else raw_step_segment}
