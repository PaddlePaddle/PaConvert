...
def test_all_type_to_bfloat16():
    ...
    # for uint8 --> bfloat16, since torch.Tensor does not support converting negative
...
def test_complex64_to_bfloat16():
    # for complex --> bfloat16, we used the new test data
    pytorch_code = textwrap.dedent(
        """
        import torch
...
def test_complex128_to_bfloat16():
    # for complex --> bfloat16, we used the new test data
    pytorch_code = textwrap.dedent(
        """
        import torch
