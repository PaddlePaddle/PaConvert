...
def test_case_4():
    run_torch_case(
        obj,
        """
        result = torch.asin_(torch.tensor([-0.6, 0.0, 0.6], dtype=torch.float64))
        """,
        ["result"],
    )
